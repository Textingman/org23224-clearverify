    ...
    <footer className="text-white py-12" style={{ backgroundColor: '#164E63' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Clear Verify</h3>
            <p style={{ color: '#A5F3FC' }}>
              Clear, simple verification for peace of mind.
            </p>
            {/* Social Icons */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/signup" style={{ color: '#A5F3FC' }} className="hover:text-white">Get Verified</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="mt-2" style={{ color: '#A5F3FC' }}>838 Walker Road, Suite 21-2, Dover, Delaware 19904</p>
            <p className="mt-2" style={{ color: '#A5F3FC' }}></p>
          </div>
        </div>
        <div className="mt-8 pt-8 text-center" style={{ borderTop: '1px solid #0891B2', color: '#A5F3FC' }}>
          <p>&copy; 2026 Clear Verify. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
