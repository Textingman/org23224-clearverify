    ...
    <div className="min-h-screen" style={{ backgroundColor: '#FFFFFF' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-5xl font-extrabold sm:text-6xl md:text-7xl" style={{ color: '#1F2937' }}>
              Clear & Simple
              <span className="block" style={{ color: '#0891B2' }}>Identity Verification</span>
            </h1>
            <p className="mt-6 max-w-2xl mx-auto text-xl" style={{ color: '#6B7280' }}>
              Clear Verify makes identity verification straightforward and stress-free — get verified quickly with confidence.
            </p>
      ...
      <section className="py-20" style={{ backgroundColor: '#FFFFFF' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold" style={{ color: '#1F2937' }}>Why Choose Clear Verify</h2>
            <p className="mt-4 text-xl" style={{ color: '#6B7280' }}>Clear, simple verification for peace of mind.</p>
          </div>
      ...
      <section className="py-20" style={{ backgroundColor: '#ECFEFF' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-10" style={{ color: '#6B7280' }}>Join thousands of people who trust Clear Verify.</p>
